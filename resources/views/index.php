...
<html lang="en-US" ng-app="employeeRecords">
    ...
    <body>
            ...
            <table class="table">
                ...
                <tbody>
                    <tr ng-repeat="employee in employees">
                        ...
                        <td>
                            <button class="btn btn-default btn-xs btn-detail" ng-click="toggle('edit', employee._id)">Edit</button>
        ...
        <script src="<?= asset('app_employee/lib/angular/angular.min.js') ?>"></script>
        <script src="<?= asset('js/jquery.min.js') ?>"></script>
        <script src="<?= asset('js/bootstrap.min.js') ?>"></script>
        <!-- AngularJS Application Scripts -->
        <script src="<?= asset('app_employee/app.js') ?>"></script>
        <script src="<?= asset('app_employee/controllers/employees.js') ?>"></script>
    </body>
</html>
